...
| `boxes` | the Käsekästchen card, the shared "Board size" row and its summary, the board of dots / lines / boxes, a closed box that keeps you on turn, a whole seeded game to the last line with the overlay texts, the replay bar, a rematch, three on one device, 360 × 780 without scrolling, and the bot drawing lines and closing boxes |
