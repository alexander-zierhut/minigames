...
const SERIES = { chain: { games: 60, config: { n: 6, chainRule: false }, maxMoves: 600 }, five: { games: 100, config: { n: 9, winLen: 5 }, maxMoves: 200 }, boxes: { games: 60, config: { n: 4 }, maxMoves: 60 } };
const BASELINE = { chain: "random-chain", five: "random-five", boxes: "random-boxes" };
